...
\begin{align}
  \vec{P_l_2} &= m_{BA} \cdot \vec{\alpha_g}
    = m_{BA} \begin{bmatrix} 0 \\ -9.81 \\ 0 \end{bmatrix}
  ...
  \vec{P_B} &= m_B \cdot \vec{\alpha_g}
    = m_B \cdot \begin{bmatrix} 0 \\ -9.81 \\ 0 \end{bmatrix}
    = \begin{bmatrix} 0 \\ -9.81 m_B \\ 0 \end{bmatrix} \\
  ...
  \vec{F_B} &=
    ...
    \begin{bmatrix} 0 \\ 9.81 m_B \\ 0 \end{bmatrix} \\
  \vec{F_B} &=
    \begin{bmatrix} 0 \\ 9.81(m_{BA}+m_A+M_B) \\ 0 \end{bmatrix}
\end{align}
...
\begin{align}
  ...
  \vec{M_A} &= \vec{BA}\times\vec{P_A}
    ...
    &= 0\vec{i} - 0\vec{j} + \left(-9.81m_Al_2\cos(\varphi)-0\right)\vec{k}
      = \begin{bmatrix} 0\\0\\-9.81m_Al_2\cos(\varphi)\end{bmatrix} \\
  \vec{M_l_2} &= (\vec{BA}/2)\times\vec{P_A}
    ...
    &= 0\vec{i} - 0\vec{j} + \frac{-9.81m_{BA}l_2\cos(\varphi)}{2}\vec{k}
      = \begin{bmatrix} 0\\0\\-9.81m_{BA}l_2\cos(\varphi)/2 \end{bmatrix}
\end{align}
\begin{align}
  \sum{\vec{M}} &= \vec{M_A} + \vec{M_l_2} + \vec{M_B} = \vec{0} \\
  \vec{0} &= \begin{bmatrix} 0\\0\\-9.81m_Al_2\cos(\varphi)\end{bmatrix}
    + \begin{bmatrix} 0\\0\\-9.81m_{BA}l_2\cos(\varphi)/2 \end{bmatrix}
    + \vec{M_B} \\
  \vec{M_B} &= - \begin{bmatrix} 0\\0\\-9.81m_Al_2\cos(\varphi)\end{bmatrix}
    - \begin{bmatrix} 0\\0\\-9.81m_{BA}l_2\cos(\varphi)/2 \end{bmatrix} \\
    &= \begin{bmatrix} 0\\0\\9.81m_Al_2\cos(\varphi)\end{bmatrix}
    + \begin{bmatrix} 0\\0\\9.81m_{BA}l_2\cos(\varphi)/2 \end{bmatrix} \\
      &= \begin{bmatrix} 0\\0\\9.81\cos(\varphi)l_2(m_A+m_{BA}/2) \end{bmatrix}
\end{align}
