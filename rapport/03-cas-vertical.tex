...
\begin{align}
	A_x(t) &= l\cos{\theta(t)}+l\cos{\varphi(t)}
	  = l \left(\cos{\theta(t)}+\cos{\varphi(t)}\right)\\
  V_{A_y}(t) &=
...
\begin{align}
	A_x(t) &= l \left(\cos(\omega t)+\cos(\arccos(1-\cos(\omega t)))\right)\\
	A_x(\theta) &= l \left(\cos(\omega \frac{\theta}{\omega})+\cos(\arccos(1-\cos(\omega \frac{\theta}{\omega})))\right)\\
	            &= l \left(\cos\theta+\cos(\arccos(1-\cos\theta))\right)\\
  V_{A_y}(t) &=
      l\cos(\omega t)\omega
